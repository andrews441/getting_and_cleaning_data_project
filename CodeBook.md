Feature Selection 
=================
This data set contains mean values of accelerometer and gyroscope measurements from 30 subjects performing six different activities: WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, and LAYING.
